...
interface JQuery {
    ...
    // transit plugin
    transition(properties: any, duration?: any, complete?: Function): JQuery;
    transition(properties: any, duration?: any, easing?: string, complete?: Function): JQuery;
    transition(properties: any, options: { duration?: any; easing?: string; complete?: Function; step?: Function; queue?: boolean; specialEasing?: any; }): JQuery;
    ...
    // extensions
    waypoint(handler: () => void, options?: any): JQuery;
    waypoint(handler: (direction: string) => void, options?: any): JQuery;
    waypoint(func: string, direction?: string, context?: any): JQuery;
    waypoint(func: 'prev', direction?: string, context?: any): JQuery;
    waypoint(func: 'next', direction?: string, context?: any): JQuery;
}
